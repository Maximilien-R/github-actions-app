...
config = LazySettings(
    ...
    core_loaders=["YAML"],
    loaders=["github_actions_app.config", "dynaconf.loaders.env_loader"],
    root_path=".",
    # environments settings
    environments=True,
    default_env="default",
    env="production",
    env_switcher="GITHUB_ACTIONS_APP_ENV",
    envvar_prefix="GITHUB_ACTIONS_APP",
    envvar="GITHUB_ACTIONS_APP_SETTINGS_FILE",
    # dotenv settings
    load_dotenv=True,
