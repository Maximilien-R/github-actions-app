...
async def test_graphql_request_parser():
    query = '{ hello(name: "Maximilien Raulic") }'
...
async def test_json_request_parser():
    payload = {"query": '{ hello(name: "Maximilien Raulic") }'}
...
async def test_extract_graphql_params():
    ...
    with patch(
        "github_actions_app.server.handlers.graphql.request_parsers._parse_graphql_params"
    ) as parse_graphql_params_mock:
        with patch(
            "github_actions_app.server.handlers.graphql.request_parsers._parse_request",
